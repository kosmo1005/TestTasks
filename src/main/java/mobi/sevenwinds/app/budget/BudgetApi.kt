...
fun NormalOpenAPIRoute.budget() {
    route("/budget") {
        route("/add").post<Unit, BudgetRecordReq, BudgetRecordReq>(info("Добавить запись")) { param, body ->
...
class BudgetYearStatsResponse(
    ...
    val items: List<BudgetRecordResp>
)
